...
public class EditWorkerProfileActivity extends AppCompatActivity {


    private EditText name , address , telephone , password , job , price ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        job = (EditText) findViewById(R.id.WorkerEditJop) ;
        price = (EditText) findViewById(R.id.WorkerCostEdit) ;
        ...
        supmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(getApplicationContext() , ProfileWorkerActivity.class);
        ...
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    job.setText(details.getString("job"));
                    price.setText(details.getString("price"));




                } catch (JSONException e) {
                    Toast.makeText(EditWorkerProfileActivity.this, "erreor" + e.toString(), Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
...
//request a json object response
        JsonObjectRequest jsonRequest = new JsonObjectRequest(Request.Method.POST, url, jsonBody, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Toast.makeText(EditWorkerProfileActivity.this, response.toString(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                //handle the error
                Toast.makeText(EditWorkerProfileActivity.this, "An error occurred", Toast.LENGTH_SHORT).show();
